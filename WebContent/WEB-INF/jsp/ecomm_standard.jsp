...
<head>
  ...
  <body>
	...
	<div class="jumbotron">
	  <div class="container">
	    <h2><spring:message code="page.title.ecomm.standard"/></h2>
	...
	<div class="container">
		...
		<div class="col-lg-4">
			<div class="panel panel-primary">
			  ...
			  <div class="panel-heading"><b>Promotion</b> &nbsp;&nbsp;(to 2015-08-15) &nbsp;&nbsp;UP TO <b>24% OFF</b></div>
			  ...
			  <table class="table">
			   	...
			   	<tr>
			   		...
			   		<td><b>CAD $612.00 + tx &nbsp;&nbsp;(POPULAR!)</b></td>
			   	</tr>
			  </table>
			</div>
		</div>
